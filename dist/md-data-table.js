    ...
    return {
      ...
      link: function ($scope, element, attrs, ctrl, transclude) {
        ...
        transclude(function (clone) {
          ...
          //var cellValue = $interpolate(clone.html())($scope.$parent);
          var cellValue = $interpolate(clone.text())($scope.$parent); // Fix Angular 1.6 +
          var cellDataToStore = {
      ...
      link: function($scope, element, attr, ctrl){
        ...
        $scope.$watch(function(){
          ...
          if(parsedValue.columnKey && ctrl && ctrl.dataStorage.customCells[parsedValue.columnKey]){
            ...
            //element.append(val);
            element.append('<span>' + val + '</span>'); // Fix "Failed to execute 'appendChild' on 'Node': parameter 1 is not of type 'Node'" Angular 1.6+
          }
